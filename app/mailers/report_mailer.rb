class ReportMailer < ActionMailer::Base
  ...
  def daily_report(recipients:)
    ...
    mail(to: "nao-responda@bizu.tasafo.org", bcc: @recipients, subject: I18n.t("notifications.daily_report.subject"))
  end
  ...
  def weekly_report(recipients:)
    ...
    mail(to: "nao-responda@bizu.tasafo.org", bcc: @recipients, subject: I18n.t("notifications.weekly_report.subject"))
  end
end
